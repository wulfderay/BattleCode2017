...
public class BotGardener extends Globals {
	...
	/*
	public static RobotType[] buildOrder = { RobotType.SOLDIER, RobotType.SOLDIER, RobotType.LUMBERJACK, RobotType.SOLDIER, RobotType.SOLDIER};
	/*/
	public static RobotType[] buildOrder = new RobotType[] {RobotType.TANK, RobotType.TANK, RobotType.TANK};//{RobotType.SCOUT, RobotType.SOLDIER, RobotType.SOLDIER, RobotType.LUMBERJACK, RobotType.SOLDIER, RobotType.SOLDIER};
	//*/
